...
$ns at 3.00 "$ns detach-agent $n0 $tcp ; $ns detach-agent $n1 $sink"
$ns at 3.50 "finish"

$ns at 0.00 "$ns trace-annotate \"Stop and Wait with normal operation\""
...
$ns at 3.10 "$ns trace-annotate \"FTP stops\""
...
$ns at 0.10 "$ftp start"
$ns at 3.00 "$ns detach-agent $n1 $tcp ; $ns detach-agent $n0 $sink"
$ns at 3.50 "finish"
